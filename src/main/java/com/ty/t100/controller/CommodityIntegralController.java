...
@RestController
@RequestMapping("/commodity-integral")
@Api(value = "API - CommodityIntegralController", description = "任务积分流水表")
public class CommodityIntegralController {

    private final CommodityIntegralService commodityIntegralService;

    public CommodityIntegralController(CommodityIntegralService commodityIntegralService) {
